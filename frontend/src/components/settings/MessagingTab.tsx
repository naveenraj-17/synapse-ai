                        ...
                        return (
                            ...
                            >
                                <div className="flex items-center gap-3">
                                    <div className={`h-8 w-8 flex items-center justify-center border ${pm?.color ?? ''}`}>
                ...
                {draft ? (
                    <div className="space-y-6">
                        ...
                        <div className="flex items-start gap-3 p-3 bg-zinc-950 border border-zinc-800">
                            ...
                            />
                            <div>
                                <label htmlFor="multi-agent-toggle" className="text-xs font-bold text-white cursor-pointer">
                                    Multi-Agent Mode
                                </label>
                                ...
                                <div className="space-y-4">
                                    ...
                                    {waMode === 'unofficial' && (
                                        <div className="space-y-3">
                                            ...
                                            <div className="flex items-center gap-2 p-3 bg-zinc-950 border border-zinc-800">
                                                <input
                                                    id="wa-risk-ack"
                                                    type="checkbox"
                                                    checked={waRiskAck}
                                                ...
                                                />
                                                <label htmlFor="wa-risk-ack" className="text-xs text-zinc-300 cursor-pointer">
