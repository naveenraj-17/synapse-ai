            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
                {ITEMS.map((item) => {
                    ...
                    return (
                        ...
                        >
                            {/* Custom checkbox */}
                            <div className={`mt-0.5 h-4 w-4 flex-shrink-0 flex items-center justify-center transition-colors border ${isChecked ? 'bg-red-500 border-red-500' : 'bg-black border-zinc-700 group-hover:border-zinc-500'}`}>
                                {isChecked && (
                            ...
                            <div className="flex-1 min-w-0">
                                <div className="flex items-center gap-2 mb-1">
                                    ...
                                    <div className={`text-sm font-bold tracking-wide transition-colors ${isChecked ? 'text-red-100' : 'text-zinc-200 group-hover:text-white'}`}>{item.label}</div>
                                </div>
