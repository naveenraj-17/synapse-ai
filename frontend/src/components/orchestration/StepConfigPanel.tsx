                    ...
                    <>
                        <div>
                            ...
                            <input
                                ...
                                onChange={(e) => update({ input_keys: e.target.value.split(',').map((s) => s.trim()).filter(Boolean) })}
                        ...
                        <div className="grid grid-cols-2 gap-2">
                            <div>
                                ...
                                <input
                                    ...
                                    value={step.max_turns ?? 15}
                                    onChange={(e) => update({ max_turns: parseInt(e.target.value) || 15 })}
                                />
                            </div>
                            <div>
