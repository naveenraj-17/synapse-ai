...
def _get_pool() -> ConnectionPool:
    ...
    from core.config import load_settings as _load_settings, sanitize_db_url as _sanitize_db_url
    db_url = _sanitize_db_url(_load_settings().get("sql_connection_string", ""))
    if not db_url:
