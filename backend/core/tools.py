...
DEFAULT_TOOLS_BY_TYPE = {
    "all_types": {
        ...
        "search_json",                # vault JSON search
    },
    "analysis": {
        "decide_search_or_analyze",
        "search_embedded_report",
        "embed_report_for_exploration",
    },
    "code": {
        "search_codebase",
    },
...
def build_virtual_tools(agent_type: str = "conversational"):
    """
    Build virtual tools filtered by agent type.
...
async def aggregate_all_tools(agent_sessions, active_agent, custom_tools_list):
    ...
    virtual_tools = build_virtual_tools(agent_type)
