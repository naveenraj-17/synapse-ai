...
then use read_file_chunk / search_file / read_json_chunk / search_json to access parts
of the file without flooding its context window.
"""
import json
import os
import re
...
def maybe_vault(tool_name: str, raw_output: str) -> str:
    ...
    return json.dumps({
        ...
        "message": (
            ...
            f"Use read_file_chunk, search_file, read_json_chunk, or search_json "
            f"to access the data at: {path}"
        ),
    })
